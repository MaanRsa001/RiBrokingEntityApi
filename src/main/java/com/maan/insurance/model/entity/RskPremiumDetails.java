...
/**
* Domain class for entity "RskPremiumDetails"
*
...
@DynamicUpdate
@Builder
@IdClass(RskPremiumDetailsId.class)
@Table(name="RSK_PREMIUM_DETAILS")


public class RskPremiumDetails implements Serializable {
