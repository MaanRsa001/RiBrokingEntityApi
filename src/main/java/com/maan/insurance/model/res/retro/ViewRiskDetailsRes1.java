...
//	private String 	acquisitionCostOSDC;
	...
	private List<InstalmentListRes1> instalmentList;
...
//	@JsonProperty("SubPremiumOSOC")
//	private String subPremiumOSOC;
//	@JsonProperty("DeduchunPercentOSOC")
//	private String deduchunPercentOSOC;
//	@JsonProperty("DeduchunPercentOSDC")
//	private String deduchunPercentOSDC;
//	@JsonProperty("SubPremiumOSDC")
//	private String subPremiumOSDC;
//	@JsonProperty("OurAssessment")
//	private String ourAssessment;
//	@JsonProperty("EgnpiOffer")
//	private String	egnpiOffer;
//	@JsonProperty("EgnpiOfferOSOC")
//	private String	egnpiOfferOSOC;
//	
//	@JsonProperty("EgnpiOfferOSDC")
//	private String 	egnpiOfferOSDC;
...
//	@JsonProperty("MinPremiumDC")
//	private String minPremiumDC;
//	@JsonProperty("MinPremiumOurShare")
//	private String minPremiumOurShare;
//	@JsonProperty("MinPremiumOurShareDC")
//	private String minPremiumOurShareDC;
//	@JsonProperty("CoverLimitXL")
//	private String coverLimitXL;
//	@JsonProperty("CoverLimitXLDC")
//	private String coverLimitXLDC;
//	@JsonProperty("CoverLimitXLOurShare")
//	private String	coverLimitXLOurShare;
//	@JsonProperty("CoverLimitXLOurShareDC")
//	private String	coverLimitXLOurShareDC;
//	@JsonProperty("DeductLimitXL")
//	private String deductLimitXL;
//	@JsonProperty("DeductLimitXLDC")
//	private String deductLimitXLDC;
//	@JsonProperty("DeductLimitXLOurShare")
//	private String	deductLimitXLOurShare;
//	@JsonProperty("DeductLimitXLOurShareDC")
//	private String	deductLimitXLOurShareDC;
	@JsonProperty("LossCF")
	private String	lossCF;
//	@JsonProperty("AnualAggregateLiabilityOSOC")
//	private String	anualAggregateLiabilityOSOC;
//	@JsonProperty("AnualAggregateLiabilityOSDC")
//	private String	anualAggregateLiabilityOSDC;
//	@JsonProperty("AnualAggregateDeduct")
//	private String	anualAggregateDeduct;
//	@JsonProperty("AnualAggregateDeductOSOC")
//	private String	anualAggregateDeductOSOC;
//	@JsonProperty("AnualAggregateDeductOSDC")
//	private String	anualAggregateDeductOSDC;
//	@JsonProperty("AnualAggregateDeductDC")
//	private String	anualAggregateDeductDC;
//	@JsonProperty("Occlimit")
//	private String	occlimit;
//	@JsonProperty("OcclimitOSOC")
//	private String	occlimitOSOC;
//	@JsonProperty("OcclimitOSDC")
//	private String	occlimitOSDC;
//	@JsonProperty("OcclimitDc")
//	private String	occlimitDc;
...
//	private String retentionYN;
	...
	@JsonProperty("LimitOrigCurOSOC")
	private String	limitOrigCurOSOC;
	@JsonProperty("LimitOrigCurOSDC")
	private String	limitOrigCurOSDC;
	@JsonProperty("FaclimitOrigCurOSOC")
	private String	faclimitOrigCurOSOC;
	@JsonProperty("FaclimitOrigCurOSDC")
	private String	faclimitOrigCurOSDC;
	@JsonProperty("EpiEstmateOSOC")
	private String	epiEstmateOSOC;
	@JsonProperty("EpiEstmateOSDC")
	private String	epiEstmateOSDC;

	@JsonProperty("FaclimitOrigCurPml")
	private String	faclimitOrigCurPml;
	@JsonProperty("FaclimitOrigCurPmlDC")
	private String	faclimitOrigCurPmlDC;
	@JsonProperty("TreatyLimitsurplusOCOSOC")
	private String	treatyLimitsurplusOCOSOC;
	@JsonProperty("TreatyLimitsurplusOCOSDC")
	private String	treatyLimitsurplusOCOSDC;
