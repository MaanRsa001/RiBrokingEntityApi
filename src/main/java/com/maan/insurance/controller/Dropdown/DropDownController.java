...
public class DropDownController 
{
	...
	public GetCommonValueRes EditModeStatus(@PathVariable ("proposalNo") String proposalNo) throws CommonValidationException {
	...
	public GetCommonValueRes getCoverLimitAmount(@PathVariable ("proposalNo") String proposalNo, @PathVariable ("departmentId") String departmentId,@PathVariable ("productId") String productId) throws CommonValidationException {
	...
	public GetCommonDropDownRes getCurrencyMasterDropDown(@PathVariable ("branchCode") String branchCode, @PathVariable ("countryId") String countryId) throws CommonValidationException {
	...
	public GetCommonValueRes getDepartmentName(@PathVariable ("branchCode") String branchCode, @PathVariable ("productCode") String productCode,@PathVariable ("deptCode") String deptCode) throws CommonValidationException {
							return dropDownservice.getDepartmentName(branchCode, productCode, deptCode);
			}
	
	
	@PostMapping("/getClaimDepartmentDropDown")
	public GetCommonDropDownRes getClaimDepartmentDropDown(@RequestBody GetClaimDepartmentDropDownReq req) throws CommonValidationException {
	...
	public GetCommonDropDownRes getSubProfitCentreMulti(@RequestBody GetSubProfitCentreMultiReq req) throws CommonValidationException {
	...
	@PostMapping("/getContractLayerNo")
	public GetCommonValueRes getContractLayerNo(@RequestBody GetContractLayerNoReq req) throws CommonValidationException {
	...
	@PostMapping("/getPreDepartmentDropDown")
	public GetCommonDropDownRes getPreDepartmentDropDown(@RequestBody GetPreDepartmentDropDownReq req) throws CommonValidationException {
	...
	public GetCommonDropDownRes getSubProfitCentreMultiDropDown(@RequestBody GetSubProfitCentreMultiDropDownReq req) throws CommonValidationException {
	...
	public GetCommonValueRes getCashLossCount(@PathVariable ("contractNo") String contractNo, @PathVariable ("departmentId") String departmentId) throws CommonValidationException {
	...
	public GetCommonDropDownRes getPersonalInfoDropDown(@PathVariable ("branchCode") String branchCode, @PathVariable ("customerType") String customerType,@PathVariable ("pid") String pid) throws CommonValidationException {
			return dropDownservice.getPersonalInfoDropDown(branchCode, customerType, pid);
	}
	@GetMapping("/getBankMasterDropDown/{branchCode}")
	public GetCommonDropDownRes getBankMasterDropDown(@PathVariable ("branchCode") String branchCode) throws CommonValidationException {
			return dropDownservice.getBankMasterDropDown(branchCode);
		}
	@GetMapping("/getConstantDropDown/{categoryId}")
	public GetCommonDropDownRes getConstantDropDown(@PathVariable ("categoryId") String categoryId) throws CommonValidationException {
			return dropDownservice.getConstantDropDown(categoryId);
		}
	@GetMapping("/getDisableStatus/{contractNo}/{layerNo}")
	public GetCommonValueRes getDisableStatus(@PathVariable ("contractNo") String contractNo, @PathVariable ("layerNo") String layerNo) throws CommonValidationException {
				return dropDownservice.getDisableStatus(contractNo, layerNo);
		}
	@GetMapping("/getDisableStatus1/{contractNo}/{layerNo}")
	public GetCommonValueRes getDisableStatus1(@PathVariable ("contractNo") String contractNo, @PathVariable ("layerNo") String layerNo) throws CommonValidationException {
...
//		}
	...
	public CommonResponse riskDetailsEndorsement(@PathVariable ("proposalNo") String proposalNo, @PathVariable ("endtStatus") String endtStatus) throws CommonValidationException {
				return dropDownservice.riskDetailsEndorsement(proposalNo, endtStatus);
		}
	@GetMapping("/updateSubClass/{proposalNo}/{type}")
	public CommonResponse updateSubClass(@PathVariable ("proposalNo") String proposalNo, @PathVariable ("type") String type) throws CommonValidationException {
				return dropDownservice.updateSubClass(proposalNo, type);
		}
	@GetMapping("/updateRenewalEditMode/{proposalNo}/{status}/{updateProposalNo}")
	public CommonResponse updateRenewalEditMode(@PathVariable ("proposalNo") String proposalNo, @PathVariable ("status") String status, @PathVariable ("updateProposalNo") String updateProposalNo) throws CommonValidationException {
				return dropDownservice.updateRenewalEditMode(proposalNo, status,updateProposalNo);
		}
	@GetMapping("/updateEditMode/{proposalNo}/{status}/{updateProposalNo}")
	public CommonResponse updateEditMode(@PathVariable ("proposalNo") String proposalNo, @PathVariable ("status") String status, @PathVariable ("updateProposalNo") String updateProposalNo) throws CommonValidationException {
				return dropDownservice.updateEditMode(proposalNo, status,updateProposalNo);
		}
	@GetMapping("/updateSubEditMode/{proposalNo}/{status}/{updateProposalNo}")
	public CommonResponse updateSubEditMode(@PathVariable ("proposalNo") String proposalNo, @PathVariable ("status") String status, @PathVariable ("updateProposalNo") String updateProposalNo) throws CommonValidationException {
				return dropDownservice.updateSubEditMode(proposalNo, status,updateProposalNo);
		}
	@GetMapping("/getBaseProposal/{proposalNo}")
	public GetCommonValueRes getBaseProposal(@PathVariable ("proposalNo") String proposalNo) throws CommonValidationException {
	...
	public GetCommonDropDownRes getCurrencyShortList(@PathVariable ("branchCode") String branchCode,@PathVariable ("countryId") String countryId) throws CommonValidationException 
	{
	...
	public GetCommonDropDownRes getCountryDropDown(@PathVariable ("branchCode") String branchCode) throws CommonValidationException 
	{
...
public GetCommonDropDownRes getTerritoryRegionList(@PathVariable ("branchCode") String branchcode) throws CommonValidationException 
{
...
public GetCommonDropDownRes getDocType(@PathVariable ("branchCode") String branchCode, @PathVariable ("productId") String productId,@PathVariable ("moduleType") String moduleType) throws CommonValidationException 
{
...
public GetCommonDropDownRes getPolicyBranchDropDown(@PathVariable ("branchCode") String branchCode) throws CommonValidationException 
{
...
public GetCommonDropDownRes getDepartmentDropDown(@RequestBody GetDepartmentDropDownReq req) throws CommonValidationException
{
...
public GetCommonDropDownRes getSubProfitCentreDropDown(@PathVariable ("deptid") String deptid, @PathVariable ("branchCode") String branchCode,@PathVariable ("productCode") String productCode) throws CommonValidationException {
...
public GetCommonDropDownRes getUnderwriterCountryList(@PathVariable ("leaderUnderriter") String leaderUnderriter,@PathVariable ("branchCode") String branchCode) throws CommonValidationException 
{
...
public GetCommonValueRes getUnderWriterLimmit(@PathVariable ("uwName") String uwName,@PathVariable ("processId") String processId,@PathVariable ("productId") String pid,@PathVariable ("deptId") String deptId) throws CommonValidationException 
{
...
public GetCommonDropDownRes getProfitCentreDropDown(@PathVariable ("branchCode") String branchCode) throws CommonValidationException 
{
return dropDownservice.getProfitCentreDropDown(branchCode);
}

@GetMapping("/getCeaseaccountStatus/{ContractNo}")
public GetCommonValueRes getCeaseaccountStatus(@PathVariable ("ContractNo") String ContractNo) throws CommonValidationException 
{
return dropDownservice.getCeaseaccountStatus(ContractNo);
}

@GetMapping("/RenewalDropDown/{branchCode}/{productCode}/{status}")
public GetCommonDropDownRes RenewalDropDown(@PathVariable ("branchCode") String branchCode, @PathVariable ("productCode") String productCode,@PathVariable ("status") String status) throws CommonValidationException 
{
return dropDownservice.RenewalDropDown( branchCode, productCode, status);
}

@GetMapping("/getTerritoryDropDown/{branchCode}")
public GetCommonDropDownRes getTerritoryDropDown(@PathVariable ("branchCode") String branchCode) throws CommonValidationException 
{
...
public GetCommonDropDownRes getCrestaIDList(@PathVariable ("branchCode") String branchCode,@PathVariable ("crestaValue") String crestaValue) throws CommonValidationException 
{
...
public GetCommonDropDownRes getCrestaNameList(@PathVariable ("branchCode") String branchCode,@PathVariable ("crestaValue") String crestaValue) throws CommonValidationException 
{
...
public GetCommonDropDownRes getUnderWritterDropDown(@PathVariable ("branchCode") String branchCode,@PathVariable ("attachedUW") String attachedUW) throws CommonValidationException 
{
...
public GetCommonValueRes getCrestaName(@PathVariable ("branchCode") String branchCode,@PathVariable ("crestaValue") String crestaValue) throws CommonValidationException 
{
...
public GetCommonValueRes getAllocationDisableStatus(@PathVariable ("contractNo") String contractNo,@PathVariable ("layerNo") String layerNo) throws CommonValidationException 
{
...
public CommonResponse updatepositionMasterEndtStatus(@RequestBody UpdatepositionMasterEndtStatusReq req) throws CommonValidationException {
			return dropDownservice.updatepositionMasterEndtStatus(req.getProposalNo(),req.getEndtDate(),req.getCeaseStatus());
	}

@PostMapping("/getYearListValue")
public GetCommonDropDownRes getYearListValue(@RequestBody GetYearListValueReq req)throws CommonValidationException {

return dropDownservice.getYearListValue(req.getInceptionDate());

	}
@GetMapping("/UpdateInstallmentTransaction/{proposalNo}")
public CommonResponse updateInstallmentTransaction(@PathVariable ("proposalNo") String proposalNo) throws CommonValidationException {
...
public GetCommonDropDownRes getConstantDropDownET(@PathVariable ("categoryId") String categoryId,@PathVariable ("contractNo") String contractNo)throws CommonValidationException {
...
public GetCommonDropDownRes getCoverDEpartmentDropDown(@PathVariable ("branchCode") String branchCode,@PathVariable ("pid") String pid,@PathVariable ("departId") String departId)throws CommonValidationException {
...
public GetCommonDropDownRes getProductieModuleDropDown(@RequestBody GetProductModuleDropDownReq req) throws CommonValidationException {
...
public GetCommonDropDownRes getInwardBusinessTypeDropDown (@RequestBody GetInwardBusinessTypeDropDownReq req) throws CommonValidationException {
...
public GetCommonDropDownRes getTreatyTypeDropDown (@RequestBody GetTreatyTypeDropDownReq req) throws CommonValidationException {
...
public GetCommonDropDownRes getProfitCentreieModuleDropDown(@RequestBody GetProfitCentreieModuleDropDownReq req) throws CommonValidationException {
...
public GetCommonDropDownRes getDepartmentieModuleDropDown(@RequestBody GetDepartmentieModuleDropDownReq req) throws CommonValidationException {
...
public GetCommonDropDownRes getProposalStatus(@PathVariable ("excludeProposalNo") String excludeProposalNo)throws CommonValidationException {
...
public GetCommonValueRes getExcludeProposalNo(@PathVariable ("branchCode") String branchCode,@PathVariable ("proposalNo") String proposalNo,@PathVariable ("transactionNo") String transactionNo) throws CommonValidationException {
...
public GetCommonDropDownRes getConstantDropDownBusinessType(@PathVariable("categoryId") String categoryId,@PathVariable("deptId") String deptId)throws CommonValidationException {
...
public GetCommonDropDownRes getConstantDropDownBasis(@PathVariable("categoryId") String categoryId,@PathVariable("deptId") String deptId)throws CommonValidationException {
...
public GetCommonDropDownRes getCountryDate(@PathVariable("branchCode") String branchCode,@PathVariable("DEC_FILE") String DEC_FILE)throws CommonValidationException {
...
public GetCommonValueRes GetExchangeRate(@RequestBody GetExchangeRateReq req) throws CommonValidationException {
	 ...
	 */
		...
		return dropDownservice.GetExchangeRate( req.getCurrency(),req.getDate(),req.getCountryid(),req.getBranchCode());
...
public CommonResponse updatepositionMasterEndtStatus(@PathVariable("endtDate") String endtDate,@PathVariable("ceaseStatus") String ceaseStatus,@PathVariable("proposalNo") String proposalNo)throws CommonValidationException {
